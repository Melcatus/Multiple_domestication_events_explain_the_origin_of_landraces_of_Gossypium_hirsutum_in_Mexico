...
# Script to filter and annotate genomic variants
## Prerequisites: NGSEPcore_3.3.0 and NGSEPcore_4.0.3
### this script is in ./bin ; data and outfiles are in ../data/cloros/map/ ; reference data is ../data/cloros/ref/
